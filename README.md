...
One command, zero config, localhost-only. Nothing leaves your machine.
...
- **The npm package name is a placeholder.** `tower-cli` may be taken; publishing is a later step.
